...
- Generated create convenience kwargs and per-resource reference pages under `docs/generated-reference/resources/`.



## Placement rules

- `docs/changelog.md`: user-facing **Added**, **Changed**, and **Breaking** per release; stage under **Unreleased** until tagged.
...
- `.endorlabs/tasks/<slug>-<YYYY-MM-DD>/scratch/`: ephemeral markdown (readiness assessments, audits, design spikes) — gitignored; do not commit under `docs/`.
