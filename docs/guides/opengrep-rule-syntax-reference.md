...
For narrative guidance, see [authoring-opengrep-rules.md](authoring-opengrep-rules.md).
...
import.  They are optional for local OpenGrep scanning but required for
...
| Validate locally with `opengrep scan` before importing | Import untested rules to the platform |
...
- [Authoring OpenGrep Rules (guide)](authoring-opengrep-rules.md)
