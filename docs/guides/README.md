...
- [threat-modeling-for-sast-rules.md](threat-modeling-for-sast-rules.md) — CWE Top 25 checklist, first-principles questions, absence-detection patterns for Agentic Frameworks.
...
- [importing-semgrep-rules-into-endor.md](importing-semgrep-rules-into-endor.md) — Import/export maneuver usage, AF types, API constraints, and verification with endorctl.
