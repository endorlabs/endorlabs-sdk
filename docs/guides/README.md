...
- [threat-modeling-for-sast-rules.md](threat-modeling-for-sast-rules.md) — CWE Top 25 checklist, first-principles questions, absence-detection patterns for SDKs.
