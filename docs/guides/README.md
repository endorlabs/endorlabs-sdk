...
- [pr-comment-config-and-parallel-comments.md](pr-comment-config-and-parallel-comments.md) — API-backed inline PR reviews and Checks annotations; historical PRCommentConfig notes.
