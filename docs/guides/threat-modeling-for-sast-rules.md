...
The safety measure is `RedactingFilter` attached to every module-level
logger via `addFilter()`.  The threat is any logger that *lacks* this
filter.
...
## 3. CWE Top 25 Checklist for SDKs and Client Libraries
