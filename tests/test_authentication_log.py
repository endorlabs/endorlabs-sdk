...
class TestAuthenticationLog:
    ...
    def test_authentication_log_get(self) -> None:
        ...
        got = client.authentication_log.get(item.uuid, namespace=ns)
        assert got is not None
        assert got.uuid == item.uuid

    def test_authentication_log_create_raises_not_implemented(self) -> None:
