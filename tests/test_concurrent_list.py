"""Tests for concurrent list operations across namespaces.

Verifies the concurrent=True parameter behavior in facade.list() and related
methods. Tests include unit tests (mock-based) and integration tests.
"""
...
class TestFacadeConcurrentList:
    ...
    def test_concurrent_with_traverse_calls_namespace_list_first(
        ...
        # Mock namespace list to return child namespaces
        mock_ns1 = Namespace(
            uuid="ns-1",
        ...
        with (
            ...
            # Should have called list_namespaces with traverse=True
            ...
            # Should have called execute_across_namespaces
    ...
    def test_concurrent_queries_each_namespace_without_traverse(
        ...
        # Track how query_fn is called
        query_fn_calls: list[dict] = []

        def capture_query_fn(namespaces, query_fn, max_workers):
            # Call the query_fn to verify it was built correctly
    ...
    def test_concurrent_passes_filter_to_each_namespace_query(
        ...
        with (
            ...
            # The query_fn should be captured
...
class TestConcurrentListIntegration:
    ...
    def test_concurrent_list_projects_returns_results(self) -> None:
        ...
        # Use concurrent mode with limited pages
        result = client.project.list(
            concurrent=True,
            traverse=True,
            max_workers=5,
        ...
        # Should return a list (may be empty if no projects)
...
class TestConcurrentListPerformance:
    ...
    def test_concurrent_vs_sequential_timing(self) -> None:
        ...
        # Log timing (informational, not a strict assertion)
