...
class TestEndorCockpitIntegration:
    ...
    def test_namespaces(self, api_client, tenant_namespace):
        ...
        try:
            ...
            for namespace in created_namespaces:
                try:
                    self._delete_test_namespace(api_client, tenant_namespace, namespace.uuid)
    ...
    def test_api_connection(self, api_client, tenant_namespace):
        ...
        print(f"✅ Connected to Endor Labs API. Found {len(namespaces_list)} namespaces.")
    ...
    def test_list_namespaces(self, api_client, tenant_namespace, test_namespaces):
        ...
        found_namespaces = [ns for ns in all_namespaces if ns.uuid in test_namespace_uuids]
        
        assert len(found_namespaces) == len(test_namespaces)
        print(f"✅ Listed {len(all_namespaces)} namespaces, found {len(found_namespaces)} test namespaces")
    ...
    def test_get_namespace(self, api_client, tenant_namespace, test_namespaces):
        ...
        retrieved_namespace = namespaces.get_namespace(api_client, tenant_namespace, test_namespace.uuid)
    ...
    def test_delete_namespace(self, api_client, tenant_namespace):
        ...
        success = self._delete_test_namespace(api_client, tenant_namespace, namespace_uuid)
    ...
    def test_namespace_hierarchy(self, api_client, tenant_namespace):
        ...
        try:
            ...
            if child_namespace:
                self._delete_test_namespace(api_client, canonical_parent, child_namespace.uuid)
            if parent_namespace:
                self._delete_test_namespace(api_client, tenant_namespace, parent_namespace.uuid)
    ...
    def _create_test_namespace(self, client: APIClient, parent_namespace: str, name: str, description: str) -> Optional[any]:
    ...
    def _delete_test_namespace(self, client: APIClient, parent_namespace: str, namespace_uuid: str) -> bool:
...
""")
    ...
    def test_security_scan_namespace(self, api_client, tenant_namespace):
        ...
        try:
            ...
            print(f"✅ Namespace security scan completed with return code: {result.returncode}")
