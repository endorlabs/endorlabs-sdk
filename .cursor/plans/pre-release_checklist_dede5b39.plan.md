...
3. **Document** — In [docs/README.md](docs/README.md) (or equivalent): add a short note that changelog is generated with `uv run git-cliff -o CHANGELOG.md` and that conventional commits are used. Optionally add a release-checklist line: “Before release: run `uv run git-cliff -o CHANGELOG.md` and commit CHANGELOG.”
...
5. **Tag and release** — Tag `v0.1.0rc1`, push tag, create GitHub Release, attach built artifacts. Optionally add a short “Pre-Release Checklist” or “Releasing” section to [docs/README.md](docs/README.md) that references Phases 1–3 and the command to generate CHANGELOG before tagging.
...
| 2     | Changelog (git-cliff)                     | [pyproject.toml](pyproject.toml), [docs/README.md](docs/README.md), CHANGELOG.md                                   |
| 3     | Release readiness                         | [pyproject.toml](pyproject.toml), [README.md](README.md), [docs/README.md](docs/README.md)                         |
