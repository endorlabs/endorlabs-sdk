...
Modular, on-demand workflow packages for AI agents working with the Endor Cockpit SDK. Each skill is a directory containing a `SKILL.md` (condensed workflow) and optional reference files (loaded only when needed).
