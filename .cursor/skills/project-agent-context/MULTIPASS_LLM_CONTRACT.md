...
**Namespace graph (different skill):** [map-project-dependency-relationships](../map-project-dependency-relationships/SKILL.md) answers *cross-project* edges, not this per-repo bundle.
