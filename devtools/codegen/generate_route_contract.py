...
def build_contract(repo: Path) -> dict[str, Any]:
    profiles = repo / "devtools" / "codegen" / "model_sync_profiles"
...
def render_module(contract: dict[str, Any]) -> str:
    ...
    return f'''# Auto-generated by devtools/codegen/generate_route_contract.py — do not edit by hand.
...
def render_markdown(contract: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "Regenerate with `uv run python devtools/codegen/generate_route_contract.py`.",
        "",
    ...
    lines.extend(
        [
            ...
            "```",
            "",
            "See [facade-helpers.md](https://github.com/endorlabs/endorlabs-sdk/blob/main/docs/guides/facade-helpers.md) and "
            "[contracts.md](https://github.com/endorlabs/endorlabs-sdk/blob/main/docs/contracts.md#generated-accessor-helpers).",
            "",
        ]
    )
    return "\n".join(lines)
