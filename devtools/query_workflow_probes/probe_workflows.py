...
Usage:
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py recipe-parity -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py prf-counts -n example-tenant --max-projects 5
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py finding-list-join -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py findinglog-group -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py dm-group -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py nested-list -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py scan-latest-join -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py collect-row-parity -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py malware-category-split -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py tenant-finding-totals -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py query-escape-hatch-group-by-time -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py authlog-group-by-time -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py nested-finding-mask -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py severity-validate-sample -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py collect-prf-rows -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py probe-ref-pagination-wire -n example-tenant
  uv run --env-file .env-admin python .tmp/query_workflow_probes/probe_workflows.py all -n example-tenant --out .tmp/query_workflow_probes/results
"""
