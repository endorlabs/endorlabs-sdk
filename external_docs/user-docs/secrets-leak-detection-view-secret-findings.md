...
downloaded: 2025-12-11 11:32:37
---
...
[Print entire section](/secrets-leak-detection/view-secret-findings/_print.html)
...
3. Select **Secrets** under **First Party Code** to view secret findings.
   ...
   ![Findings of secrets](../../images/findings-secret.png)
...
![Secrets findings right sidebar](../../images/vertical-secrets.png)
