...
downloaded: 2025-11-20 11:49:19
---
...
You can make changes to the Bitbucket Data Center App integrations or delete them. You can view the activity logs for the Bitbucket App and rescan your Bitbucket projects on demand.
...
2. Click **Manage** next to **Bitbucket** under **Source Control Managers**.
   ...
   ![Manage Bitbucket App](../../../../images/bitbucket-app-manage.png)
3. Click the three vertical dots next to the integration.

   You can choose from the following options:

   * [**Edit Integration**](#edit-bitbucket-data-center-app-integration)
   * [**Delete Integration**](#delete-endor-labs-bitbucket-data-center-app)
...
2. You can update your personal access token and choose the scanners.
   ![Edit Bitbucket App](../../../../images/BitbucketAppManageEdit.png)
3. Click **Save**.
