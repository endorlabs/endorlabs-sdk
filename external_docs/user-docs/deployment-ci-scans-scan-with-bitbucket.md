...
downloaded: 2026-01-26 10:08:51
---
...
2. In your `bitbucket-pipelines.yml` file customize the job configuration based on your project’s requirements using [the following example](#example).
