...
downloaded: 2026-01-16 09:50:50
---
...
[Print entire section](/integrations/package-manager/rubygems-private-package-manager/_print.html)
...
7. Specify the package manager URL. Some example formats include:
   ...
   * `https://rubygems.pkg.github.com/<your org>`
   * `https://gitlab.example.com/api/v4/projects/<project_id>/packages/rubygems`
   * `https://gitlab.example.com/api/v4/groups/<group_id>/packages/rubygems`
