...
downloaded: 2026-01-26 10:07:49
---
...
* **Endor AI Chat**: Ask natural language questions about security findings, scan results, package versions, and vulnerabilities.
...
Ask natural language questions about your findings and vulnerabilities.](/ai/ai-chat/)
[### Search for AI Models

Discover and evaluate AI models from Hugging Face with comprehensive scoring.](/ai/ai-model/)
[### AI Model Scores

Understand how AI models are scored across security, activity, popularity, and operational integrity.](/ai/ai-model-scores/)

[### AI Model Findings

Detect, view, and manage AI model findings in your projects with automated scanning and policy enforcement.](/ai/ai-llm/)
[### AI Model Policies

Configure finding policies to enforce organizational restrictions on AI model usage and quality standards.](/ai/ai-model-policies/)
[### AI Access Management

Manage access to AI-powered features and configure which AI services are enabled for your organization.](/ai/ai-access/)

[### Use DroidGPT

Discover open-source software components and troubleshoot errors with intelligent recommendations.](/ai/droidgpt/)
