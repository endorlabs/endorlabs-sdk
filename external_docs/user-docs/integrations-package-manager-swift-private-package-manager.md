...
downloaded: 2026-01-29 22:23:43
---
...
9. You can also select either **Authentication Token** or **Basic Auth** as the **Authentication Method**.
...
To connect to private repositories of Swift Package Manager enter the package manager URL and the package registry credentials such as username and password, or authentication token.
