...
downloaded: 2026-01-26 10:05:49
---
...
[Print entire section](/deployment/mcp/cursor/_print.html)



# Endor Labs MCP server in Cursor

Learn how to deploy and run the Endor Labs MCP server in Cursor.
...
* Configure the MCP server: Configure the MCP server in Cursor. You can use the interactive configuration tool or manually configure the MCP server. See [Configure the MCP server in Cursor](#configure-the-mcp-server-in-cursor) for more details. No configuration is required to get started with the Developer Edition.
...
* Configure Cursor rules (optional): Configure Cursor rules to guide AI development with Endor Labs. See [Configure Cursor rules](#configure-cursor-rules) for more details.
...
Fill in your configuration above and click **Generate** to create a one-click installation link
for Cursor.
