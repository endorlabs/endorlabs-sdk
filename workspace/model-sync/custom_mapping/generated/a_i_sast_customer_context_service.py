...
#   filename:  a_i_sast_customer_context_service.json
...
class V1AISastCustomerContextSpec(BaseModel):
    context: str = Field(
        ...,
        description='Human-authored guidance text for this scope; consumed as-is by the summary pipeline.',
    )
...
class AISastCustomerContextServiceUpdateAISastCustomerContextBody(BaseModel):
    ...
    request: V1UpdateRequest | None = Field(
        None, description='Update request parameters.'
    )
...
class V1ListAISastCustomerContextsResponseList(BaseModel):
    objects: list[Object1] | None = Field(
        None, description='Customer contexts matching the query.'
    )
    response: V1ListResponse | None = Field(None, description='List response metadata.')


class V1ListAISastCustomerContextsResponse(BaseModel):
    count_response: V1CountResponse | None = Field(
        None, description='Standard count payload.'
    )
    group_response: V1GroupResponse | None = Field(
        None, description='Standard group payload.'
    )
    list: V1ListAISastCustomerContextsResponseList | None = Field(
        None, description='Standard list payload.'
    )
