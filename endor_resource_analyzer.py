...
class EndorResourceAnalyzer:
    ...
    def _get_raw_api_entities(
        ...
        try:
            # Use the same pattern as BaseResourceOperations
            headers = self.client.default_headers
            url = f"v1/namespaces/{self.namespace}/{resource_type.lower()}s"
    ...
    def _analyze_raw_json_attributes(self, entities: List[Dict], model: ResourceModel):
        """Analyze attributes from raw JSON entities."""
