...
|----|-----|--------|-------|----------------|
| agent-context | `endor-agent-context` | `endorlabs.workflows.agent_context.cli` | endor-project-agent-context | .endorlabs-context/workspace/projects/<slug>_<timestamp>/ |
...
| relationships-map | `—` | `endorlabs.workflows.estate.analyze.project_map.map` | endor-map-project-dependency-relationships | .endorlabs-context/workspace/projects/ |
