...
| compile-dependency-graph | `endor-compile-dependency-graph` | `endorlabs.workflows.relationships.dependency_graph` | endor-compile-dependency-graph | .endorlabs-context/session/<namespace>/ |
| context-bootstrap | `endor-context` | `endorlabs.context.cli` | — | .endorlabs-context/ |
| graph-summarize | `endor-graph-summarize` | `endorlabs.workflows.relationships.summarize_session` | endor-compile-dependency-graph | stdout or --json |
