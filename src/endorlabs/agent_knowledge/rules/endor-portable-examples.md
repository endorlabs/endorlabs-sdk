...
- hygiene
- placeholders
summary: Use placeholders in git-tracked agent content; never commit customer estate
...
- Project: user-provided URL/UUID or `Project.list` / `Project.resolve` at runtime.
