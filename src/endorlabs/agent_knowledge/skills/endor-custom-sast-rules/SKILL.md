...
description: Author, validate, and import custom OpenGrep/Semgrep SAST rules into
  the Endor Labs platform. Use when the user wants to write security rules, perform
  threat modeling for SAST, create absence-detection rules, validate rule YAML, or
  import Semgrep rules into Endor Labs.
---
