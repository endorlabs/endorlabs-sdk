...
description: 'Namespace-scoped bulk workflows via endor-estate: pull JSONL workspace,
  disk-first analyze (cardinality, risk, compile graph, dashboard), summarize, export-version,
