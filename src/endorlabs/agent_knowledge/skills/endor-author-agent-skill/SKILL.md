...
|------|----------|--------|
| Bootstrap rules | `sdk/rules/<id>.md` | [rule.schema.json](../../schema/rule.schema.json) |
| Reference contracts | `sdk/contracts/<id>.md` | [contract.schema.json](../../schema/contract.schema.json) |
