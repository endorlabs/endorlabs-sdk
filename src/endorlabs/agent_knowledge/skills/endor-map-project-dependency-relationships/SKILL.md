...
description: Walk all projects in a namespace, identify direct and indirect dependency
  relationships between projects via produced/consumed package versions, and emit
  a JSON relationship graph with evidence scoring.
---
