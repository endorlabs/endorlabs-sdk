...
description: 'Live API namespace project graph: producer PackageVersion + consumer
  DependencyMetadata joined by coordinate, with direct/indirect paths and evidence
  tiers. JSON only — not single-project SBOM export.'
---
