...
description: 'Live API namespace project graph: consumer DependencyMetadata joined
  to producer PackageVersion coordinates, with direct/indirect paths. Optional focus-producer-project-uuid
  for breaking-change consumer discovery. Not single-project SBOM export — use endor-project-retrieval-bundle.'
---
