...
description: 'Extend the SDK client surface after OpenAPI changes: model sync, registry
  overlay, payload builders, and integration tests. Use when a new API resource appears,
  facade behavior diverges from generated contract, or list/get/create needs validation—not
  for hand-implementing every resource from scratch.'
---
