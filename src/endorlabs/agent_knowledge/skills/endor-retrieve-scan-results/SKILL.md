...
description: Query projects, scan results, and findings from the Endor Labs platform
  using the SDK. Use when the user wants to retrieve scan results, list findings,
  look up a project by repository URL, or build reports from scan data. Covers namespace
  traversal for tenant-wide queries.
---
