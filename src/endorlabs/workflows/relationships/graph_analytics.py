...
from .graph_enrich import dep_data_from_record, load_corpus_records
...
def _load_graph(session_dir: Path) -> dict[str, Any]:
    for name in (
    ...
    msg = f"No compile graph under {session_dir}"
...
def run_graph_analytics_phase(
    ...
    *,
    ...
    if package_name_match:
        ...
        write_json(
            str(session_dir / "package_subgraph.json"),
            pkg_sub,
            base_dir=session_dir,
        )
    return metrics
