...
description: Investigate scan regressions by resolving a project, retrieving anomalous
  ScanResults, pulling ScanLogs, and generating result/log diffs with repeatable parameterized
  scripts.
---
