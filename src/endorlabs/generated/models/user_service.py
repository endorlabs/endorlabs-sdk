...
class V1ListUsersResponseList(BaseModel):
...
class V1ListUsersResponse(BaseModel):
    ...
    list: V1ListUsersResponseList | None = None


class V1UpdateUserRequest(BaseModel):
    object: V1User | None = None
    request: V1UpdateRequest | None = None


class UserService(BaseModel):
    v1ListUsersResponse: V1ListUsersResponse | None = None
    v1UpdateUserRequest: V1UpdateUserRequest | None = None
    v1User: V1User | None = None
