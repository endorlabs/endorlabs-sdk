...
class V1PRCommentConfigSpec(BaseModel):
    ...
    """
    The platform type for this configuration (for example, GitHub or GitLab).
    """
    template: V1PRCommentsTemplate
    """
    The Go template in text format to be used for the PR comments.
    """
...
class PRCommentConfigServiceCreatePRCommentConfigBody(BaseModel):
    ...
    tenant_meta: dict[str, Any] | None = Field(
        None, title='PR comment configurations are associated with a tenant.'
    )
    """
    PR comment configurations are associated with a tenant.
    """
    uuid: str | None = None
    """
    The UUID of a PR comment configuration.
    """
...
class PRCommentConfigServiceUpdatePRCommentConfigBody(BaseModel):
    """
    Request to update a PR comment configuration.
    """
...
class V1ListPRCommentConfigsResponse(BaseModel):
    """
    Response to the request to list PR comment configurations.
    """
