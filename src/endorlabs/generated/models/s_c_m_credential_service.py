...
class SpecSCMCredentialStatusState(StrEnum):
    """
    The status of the SCM credential.
...
class SpecSCMCredentialStatus(BaseModel):
    ...
    """
    last_tested_at is the time when the credential was last tested.
    """
    state: SpecSCMCredentialStatusState | None = 'STATE_UNSPECIFIED'
    """
    The state of the SCM credential.
    """
...
class V1SCMCredentialSpec(BaseModel):
    access_token: str
    """
    Access token for authenticating to the SCM platform.
    ...
    """
    The SCM platform type (GitHub, GitLab, Bitbucket, Azure, etc.).
    """
    scm_credential_status: SpecSCMCredentialStatus | None = None
    target_url: str
    """
    The target URL of the SCM org or repo for which this credential applies.
    Examples:
...
class SCMCredentialServiceCreateSCMCredentialBody(BaseModel):
    """
    SCMCredential represents SCM org/repo credentials for private dependency resolution.
    ...
    uuid: str | None = None
    """
    The UUID of the SCM credential.
    """
...
class SCMCredentialServiceUpdateSCMCredentialBody(BaseModel):
    """
    Request to update an SCM credential.
    """
...
class V1ListSCMCredentialsResponse(BaseModel):
    """
    Response to the request to list SCM credentials.
    """
