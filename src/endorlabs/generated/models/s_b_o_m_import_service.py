...
class V1ImportedSBOMSpec(BaseModel):
    ...
    cyclone_dx: str | None = None
    """
    CycloneDX is the cyclonedx bom struct serialized to a string.
    """
    cyclone_dx_bytes: Base64Str | None = None
    """
    CycloneDX bom struct encoded in zstd bytes.
    """
    identifier: str | None = None
    """
    The unique identifer of the component of a SBOM.
    For example, a CycloneDX SBOM will have metadata.component.bom-ref as the identifier of the main component.
    """
    kind: V1SBOMKind
    main_component_purl: str | None = None
    """
    The PURL of the main component of a SBOM.
    """
    spdx: str | None = None
    """
    SPDX is the spdx bom struct serialized to a string.
    """
    spdx_bytes: Base64Str | None = None
    """
    SPDX bom struct encoded in zstd bytes.
    """
    supplier_name: str | None = None
    """
    The suplier name of the imported SBOM.
    """
    version: int | None = None
    """
    The version of the imported SBOM.
    """
...
class V1ListSBOMImportsResponse(BaseModel):
    """
    Response to the request to list SBOMs.
    """
