...
class V1IPAddressPolicySpec(BaseModel):
    allowed_ip_subnets: list[str]
    """
    The list of allowed IP subnets from where traffic should be
    allowed.
    """
...
class IPAddressPolicyServiceCreateIPAddressPolicyBody(BaseModel):
    ...
    """
    spec: V1IPAddressPolicySpec
    """
    Resource kind specific data.
    """
    tenant_meta: dict[str, Any] | None = Field(
        None, title='Namespace of the ip address policy.'
    )
    """
    ...
    uuid: str | None = None
    """
    The UUID of the ip address policy.
    """
...
class V1ListIPAddressPoliciesResponse(BaseModel):
    """
    Response returned for requests to list ip address policies.
    """
