...
#   filename:  support_access_request_service.json
...
class V1SupportAccessRequestSpec(BaseModel):
    authorization_policy_uuid: str | None = Field(
        None, description='The uuid of the resource.'
    )
    expiration_time: AwareDatetime = Field(
        ..., description='Expiration time of the support access.'
    )
...
class SupportAccessRequestServiceCreateSupportAccessRequestBody(BaseModel):
    ...
    spec: V1SupportAccessRequestSpec | None = None
...
class V1SupportAccessRequest(BaseModel):
    meta: V1Meta = Field(..., description='Metadata required for all objects.')
    propagate: bool | None = Field(
        None,
        description='Indicates that the object should be visible in the child namespaces.',
...
class SupportAccessRequestService(BaseModel):
    SupportAccessRequestServiceCreateSupportAccessRequestBody_1: (
        SupportAccessRequestServiceCreateSupportAccessRequestBody | None
    ) = Field(None, alias='SupportAccessRequestServiceCreateSupportAccessRequestBody')
    v1SupportAccessRequest: V1SupportAccessRequest | None = None
