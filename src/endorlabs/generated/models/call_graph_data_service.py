...
#   filename:  call_graph_data_service.json
...
class V1CallGraphData(BaseModel):
    any: GoogleprotobufAny | None = Field(
        None,
        description='Callgraph is encoded in json bytes.\nUse the HTTP header x-callgraph-encoding=any to get the spec in this format.',
    )
    context: V1Context | None = Field(
        None,
        description='The context of the call graph that is equal to the context of the associated\npackage.',
    )
    ...
    storage_url: str | None = Field(
        None, description='The URL of the storage location of the callgraph.'
    )
    tenant_meta: V1TenantMeta = Field(
        ..., description='Namespaces are associated with a tenant.'
    )
    uuid: str | None = Field(None, description='The UUID for a call graph resource.')
    zstd_bytes: Base64Str | None = Field(
        None,
...
class V1ListCallGraphDataResponseList(BaseModel):
    objects: list[Object] | None = None
    response: V1ListResponse | None = None


class V1ListCallGraphDataResponse(BaseModel):
    count_response: V1CountResponse | None = None
    group_response: V1GroupResponse | None = None
    list: V1ListCallGraphDataResponseList | None = None


class CallGraphDataService(BaseModel):
    v1CallGraphData: V1CallGraphData | None = None
    v1ListCallGraphDataResponse: V1ListCallGraphDataResponse | None = None
