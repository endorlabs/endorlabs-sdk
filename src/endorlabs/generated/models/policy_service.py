...
class V1PolicyNotificationAction(BaseModel):
    ...
    """
    The list of UUIDs of the notification targets that are configured for
    this policy.
    """
...
class PolicyExceptionAction(BaseModel):
    ...
    """
    Expiration time of the exception policy.
    """
    reason: V1ExceptionReason
    """
    Reason for the exception policy.
    """
    tags: list[str] | None = None
    """
    [Optional] List of tags to add to spec.exception.tags in matching
    findings.
    """
...
class V1PolicySpec(BaseModel):
    ...
    """
    Custom fields to group policy output by. This may be a
    ...
    """
    The set of tags that projects that are matched
    ...
    """
    The set of tags that projects must have for the policy to be executed
    ...
    """
    Identifies all resources that a policy requires.
    ...
    rule: str | None = None
    """
    The policy rule in text format.
    ...
    """
    Template parameter metadata for this template version.
    """
    template_uuid: str | None = None
    """
    Indicates that the policy is created from a template.
    """
    template_values: dict[str, PolicyTemplateParameterValues] | None = None
    """
    The map of key-value pairs for parameters used to customize the template.
    """
...
class PolicyServiceCreatePolicyBody(BaseModel):
    ...
    tenant_meta: dict[str, Any] | None = Field(
        None, title='Policies can be issued per namespace.'
    )
    """
...
class V1ListPoliciesResponse(BaseModel):
    """
    Response to the request to list policies.
    """
