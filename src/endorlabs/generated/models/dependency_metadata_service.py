...
class DeclaredLicense(BaseModel):
    category: str | None = Field(
        None, description='License category (e.g. "Restricted").'
    )
...
class DependencyMetadataDependencyData(BaseModel):
    ...
    declared_licenses: list[DeclaredLicense] | None = Field(
        None, description='Declared license information for the dependency.'
    )
    direct: bool = Field(..., description='True if this is a direct dependency.')
    discovered_licenses: list[DiscoveredLicense] | None = Field(
        None, description='Discovered license information for the dependency.'
    )
