...
class V1LicenseDependencySpec(BaseModel):
    ...
    """
    Whether we classify the license as declared.
    """
    ...
    """
    package_version_uuids: list[str] | None = None
    """
    Package versions of dependencies with the license.
    """
    spdx_id: str
    """
...
class LicenseDependencyServiceCreateLicenseDependencyBody(BaseModel):
    meta: V1Meta
    """
    The metadata of the license dependency.
    """
    spec: V1LicenseDependencySpec
    """
    The specification of the license dependency.
    """
    tenant_meta: dict[str, Any] | None = Field(
        None, title='The tenant metadata of the license dependency.'
    )
    """
    The tenant metadata of the license dependency.
    """
    uuid: str | None = None
    """
    The UUID of the license dependency.
    """
...
class Object(BaseModel):
    ...
    The metadata of the license dependency.
    """
    spec: V1LicenseDependencySpec | None = None
    """
    The specification of the license dependency.
    """
    tenant_meta: dict[str, Any] | None = Field(
...
class LicenseDependencyServiceUpdateLicenseDependencyBody(BaseModel):
    """
    Request to update a license dependency.
    """
...
class V1ListLicenseDependenciesResponse(BaseModel):
    """
    Response to list all the license dependencies.
    """
