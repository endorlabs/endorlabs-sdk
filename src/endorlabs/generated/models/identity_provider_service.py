...
class IdentityProviderOIDCProvider(BaseModel):
    ...
    discover_url: str
    """
    The well-known URL of the OIDC provider.
    """
    key: str
    """
    The key to authenticate with the provider for callbacks.
    """
    scopes: list[str] | None = None
    secret: str
    """
    The secret to authenticate with the provider for callbacks.
    """
...
class V1SAMLProvider(BaseModel):
    ...
    """
    Attributes that must be mapped to the Endor identity.
    """
...
class IdentityProviderServiceCreateIdentityProviderBody(BaseModel):
    ...
    tenant_meta: dict[str, Any] | None = Field(
        None, title='IdentityProviders are associated with a tenant and namespace.'
    )
    """
    IdentityProviders are associated with a tenant and namespace.
    """
...
class V1ListIdentityProvidersResponse(BaseModel):
    """
    Response to the request to list identity providers.
    """
