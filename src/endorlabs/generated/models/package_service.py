...
class Endorv1Package(BaseModel):
    meta: V1Meta = Field(..., description='Metadata required for all objects.')
    spec: V1PackageSpec | None = None
    tenant_meta: V1TenantMeta | None = Field(
        None, description='Packages are associated with a tenant.'
    )
    uuid: str | None = Field(
        None, description='UUID is a universally unique identifier for a package.'
    )
...
class V1ListPackagesResponseList(BaseModel):
    objects: list[Object] | None = None
    response: V1ListResponse | None = None


class V1ListPackagesResponse(BaseModel):
    count_response: V1CountResponse | None = None
    group_response: V1GroupResponse | None = None
    list: V1ListPackagesResponseList | None = None


class PackageService(BaseModel):
    endorv1Package: Endorv1Package | None = None
    v1ListPackagesResponse: V1ListPackagesResponse | None = None
