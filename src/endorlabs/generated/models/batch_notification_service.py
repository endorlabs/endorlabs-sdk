...
class V1BatchNotificationSpec(BaseModel):
    ...
    finding_uuids: list[str] | None = None
    """
    List of finding UUIDs to create notifications.
    """
    notification_target_uuid: str | None = None
    """
...
class BatchNotificationServiceCreateBatchNotificationBody(BaseModel):
    ...
    Metadata required for all objects.
    """
    spec: V1BatchNotificationSpec | None = None
    """
    Resource kind specific data.
    """
    tenant_meta: dict[str, Any] | None = Field(
        None, title='Information about the tenant.'
    )
    """
