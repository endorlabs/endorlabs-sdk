...
#   filename:  license_summary_service.json
...
class V1LicenseSummarySpec(BaseModel):
    copyright_count: int | None = Field(
        None, description='The number of copyrights found in the project dependencies.'
    )
    declared_spdx_ids: list[str] | None = Field(
        None,
        description='The declared SPDX IDs per license associated with the project.',
    )
    notices_count: int | None = Field(
        None,
        description='The number of notice files found in the project dependencies.',
    )
    singular_spdx_ids: list[str] | None = Field(
        None,
...
class LicenseSummaryServiceCreateLicenseSummaryBody(BaseModel):
    meta: V1Meta = Field(..., description='The metadata of the license summary.')
    spec: V1LicenseSummarySpec = Field(
        ..., description='The specification of the license summary.'
    )
    ...
    uuid: str | None = Field(None, description='The UUID of the license summary.')


class Object(BaseModel):
    meta: V1Meta | None = Field(
        None, description='The metadata of the license summary.'
    )
    spec: V1LicenseSummarySpec | None = Field(
        None, description='The specification of the license summary.'
    )
    tenant_meta: dict[str, Any] | None = Field(
        None,
        description='The tenant metadata of the license summary.',
...
class LicenseSummaryServiceUpdateLicenseSummaryBody(BaseModel):
...
class V1LicenseSummary(BaseModel):
    meta: V1Meta = Field(..., description='The metadata of the license summary.')
    spec: V1LicenseSummarySpec = Field(
        ..., description='The specification of the license summary.'
    )
    tenant_meta: V1TenantMeta | None = Field(
        None, description='The tenant metadata of the license summary.'
    )
    uuid: str | None = Field(None, description='The UUID of the license summary.')
...
class V1ListLicenseSummariesResponseList(BaseModel):
    objects: list[Object1] | None = None
    response: V1ListResponse | None = None


class V1ListLicenseSummariesResponse(BaseModel):
    count_response: V1CountResponse | None = None
    group_response: V1GroupResponse | None = None
    list: V1ListLicenseSummariesResponseList | None = None


class LicenseSummaryService(BaseModel):
    LicenseSummaryServiceCreateLicenseSummaryBody_1: (
        LicenseSummaryServiceCreateLicenseSummaryBody | None
    ) = Field(None, alias='LicenseSummaryServiceCreateLicenseSummaryBody')
    LicenseSummaryServiceUpdateLicenseSummaryBody_1: (
        LicenseSummaryServiceUpdateLicenseSummaryBody | None
    ) = Field(None, alias='LicenseSummaryServiceUpdateLicenseSummaryBody')
    v1LicenseSummary: V1LicenseSummary | None = None
    v1ListLicenseSummariesResponse: V1ListLicenseSummariesResponse | None = None
