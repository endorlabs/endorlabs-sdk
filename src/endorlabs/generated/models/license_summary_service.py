...
class V1LicenseSummarySpec(BaseModel):
    copyright_count: int | None = None
    """
    The number of copyrights found in the project dependencies.
    """
    declared_spdx_ids: list[str] | None = None
    """
    The declared SPDX IDs per license associated with the project.
    """
    notices_count: int | None = None
    """
    The number of notice files found in the project dependencies.
    """
    singular_spdx_ids: list[str] | None = None
    """
    The singular SPDX IDs of all licenses associated with the project.
    """
    spdx_ids: list[str] | None = None
    """
    The SPDX IDs per license associated with the project.
...
class LicenseSummaryServiceCreateLicenseSummaryBody(BaseModel):
    meta: V1Meta
    """
    The metadata of the license summary.
    """
    spec: V1LicenseSummarySpec
    """
    The specification of the license summary.
    """
    tenant_meta: dict[str, Any] | None = Field(
        None, title='The tenant metadata of the license summary.'
    )
    """
    The tenant metadata of the license summary.
    """
    uuid: str | None = None
    """
    The UUID of the license summary.
    """
...
class Object(BaseModel):
    ...
    The metadata of the license summary.
    """
    spec: V1LicenseSummarySpec | None = None
    """
    The specification of the license summary.
    """
    tenant_meta: dict[str, Any] | None = Field(
...
class LicenseSummaryServiceUpdateLicenseSummaryBody(BaseModel):
    """
    Request to update a license summary.
    """
...
class V1ListLicenseSummariesResponse(BaseModel):
    """
    Response to list all the license summaries.
    """
