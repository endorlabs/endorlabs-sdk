...
class V1TenantSpec(BaseModel):
    ...
    """
    organization_urls: list[str] | None = None
    """
    The list of URLs which are associated with the given organization which can be included in the supplier SBOM information.
    """
    organizational_contacts: list[OrganizationalContact] | None = None
    """
    The list of contact that we can put as the contact in the SBOM export supplier information.
    """
    ...
    """
    The placement zone for internal tenant routing and sharding.
    """
    state: str | None = None
    """
    The state of a users address.
    """
...
class V1ListTenantsResponse(BaseModel):
    """
    Response to the request to list tenants.
    """
