...
class V1EmbeddingProvider(StrEnum):
    """
    EmbeddingProvider is the provider of the embeddings.
    """
...
class V1VectorStoreSpec(BaseModel):
    apply_uniqueness_index_changes: bool | None = None
    """
    apply_uniqueness_index_changes explicitly authorizes migrating uniqueness indexes
    ...
    """
    Dimensions is the number of dimensions to be used.
    """
    embedding_model: V1EmbeddingModel
    """
    EmbeddingModel is the embedding model of the vector store.
    """
    embedding_provider: V1EmbeddingProvider
    """
...
class Object(BaseModel):
    """
    Represents a vector store in the system. The vector store will create all
    ...
    """
    spec: V1VectorStoreSpec | None = None
    """
    The internal specification of the object.
    """
    tenant_meta: V1TenantMeta | None = None
    """
    VectorStores are associated with a tenant or are global.
    """
    uuid: str | None = None
    """
...
class V1ListVectorStoresResponse(BaseModel):
    """
    Response to the request to list available VectorStores.
    """
