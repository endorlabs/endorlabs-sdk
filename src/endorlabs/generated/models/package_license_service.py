...
class PackageLicenseInfoLicenseInfoMapping(BaseModel):
    ...
    """
    Source of the license mapping information.
    """
...
class V1PackageLicenseInfo(BaseModel):
    additional_files: dict[str, int] | None = None
    """
    Other files that contain the same license, mapped to line number.
    """
    confidence: float | None = None
    """
    The confidence in the license match.
    """
    copyrights: list[str] | None = None
    """
    Copyrights within the license text.
    """
    ...
    hash: str | None = None
    """
    Hash should only be set if matched_text is empty.
    """
    ...
    """
    mapping_info: PackageLicenseInfoLicenseInfoMapping | None = None
    """
    Additional context about the raw license description.
    """
    ...
    """
    notices_file: bool | None = None
    """
    True if it is a notices file identified by name.
    """
...
class V1PackageLicenseSpec(BaseModel):
    ...
    """
    The discovered licenses found in the source code.
    """
    ...
    """
    declared_code_licenses: list[DeclaredCodeLicense] | None = None
    """
    The declared licenses found in the source code.
    """
    license_text: dict[str, str] | None = None
    """
    Map of sha256 to license text.
    """
    ...
    """
    UUID of the project that the package license relates to.
    """
    version: V1Version | None = None
    """
    The ref of the source code repository from which this package license
    was created.
    """
...
class PackageLicenseServiceCreatePackageLicenseBody(BaseModel):
    ...
    meta: V1Meta
    """
    The metadata of the package license.
    """
    spec: V1PackageLicenseSpec
    """
    The specification of the package license.
    """
    tenant_meta: dict[str, Any] = Field(
        ..., title='The tenant metadata of the package license.'
    )
    """
    The tenant metadata of the package license.
    """
    uuid: str | None = None
    """
...
class Object(BaseModel):
    ...
    The metadata of the package license.
    """
    spec: V1PackageLicenseSpec | None = None
    """
    The specification of the package license.
    """
    tenant_meta: dict[str, Any] | None = Field(
        None, title='The tenant metadata of the package license.'
    )
    """
    The tenant metadata of the package license.
    """
...
class V1ListPackageLicenseResponse(BaseModel):
    """
    Response to list all the package licenses.
    """
