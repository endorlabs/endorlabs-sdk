...
class SpecEndorctlConfig(BaseModel):
    ...
    """
    Maximum duration of an endorctl job in minutes.
    """
    tag: str | None = None
    """
    Default will be set to 'latest'.
    """
...
class SpecSchedulerConfig(BaseModel):
    ...
    """
    Maximum number of endorctl jobs that can be run concurrently.
    """
    tag: str | None = None
    """
    Default will be set to 'latest'.
...
class V1AuthMethodAzure(BaseModel):
    enable_managed_identity: bool | None = None
    """
    Auth using Azure managed identity for system.
    """
...
class V1AuthMethodGCP(BaseModel):
    service_account: str
    """
    Auth using GCP service account.
    """
...
class V1OnPremSchedulerSpec(BaseModel):
    ...
    connection_status: SpecConnectionStatus | None = None
    """
    Contains the connection status to onprem cluster.
    """
    endorctl_config: SpecEndorctlConfig | None = None
    """
    EndorctlConfig config contains endorctl configuration.
    """
    gcp: V1AuthMethodGCP | None = None
    helm_values: str | None = None
    """
    Contains the base64 encoded helm values.yaml file.
    """
    scheduler_config: SpecSchedulerConfig | None = None
    """
    Scheduler config contains scheduler configuration.
    """
    scheduler_version: str | None = None
    """
    Contains the version of the scheduler.
    """
    use_bazel_cache: bool | None = None
    """
    Enables bazel remote cache.
    """
...
class OnPremSchedulerServiceCreateOnPremSchedulerBody(BaseModel):
    ...
    """
    spec: V1OnPremSchedulerSpec
    """
    Spec is the internal specification of the object.
    """
    tenant_meta: dict[str, Any] = Field(..., title='Contains the namespace.')
    """
...
class Object(BaseModel):
    ...
    Metadata required for all objects.
    """
    spec: V1OnPremSchedulerSpec | None = None
    """
    Spec is the internal specification of the object.
    """
    tenant_meta: dict[str, Any] | None = Field(None, title='Contains the namespace.')
    """
    Contains the namespace.
    """
    uuid: str | None = None
...
class V1ListOnPremSchedulersResponse(BaseModel):
    """
    ListOnPremSchedulersResponse is used by ListOnPremSchedulers.
    """
