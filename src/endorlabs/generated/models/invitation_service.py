...
#   filename:  invitation_service.json
...
class SpecInvitationState(StrEnum):
    INVITATION_STATE_UNSPECIFIED = 'INVITATION_STATE_UNSPECIFIED'
    INVITATION_STATE_PENDING = 'INVITATION_STATE_PENDING'
    INVITATION_STATE_ACCEPTED = 'INVITATION_STATE_ACCEPTED'
    INVITATION_STATE_EMAIL_FAILURE = 'INVITATION_STATE_EMAIL_FAILURE'
...
class V1InvitationSpec(BaseModel):
    invitation_state: SpecInvitationState | None = 'INVITATION_STATE_UNSPECIFIED'
...
class InvitationServiceCreateInvitationBody(BaseModel):
    meta: V1Meta = Field(..., description='Metadata required for all objects.')
    spec: V1InvitationSpec
    ...
    uuid: str | None = Field(None, description='The UUID of the invitation.')
...
class V1Invitation(BaseModel):
    meta: V1Meta = Field(..., description='Metadata required for all objects.')
    spec: V1InvitationSpec
    tenant_meta: V1TenantMeta | None = Field(
        None, description='Invitations can be issued per namespace.'
    )
    uuid: str | None = Field(None, description='The UUID of the invitation.')
...
class V1ListInvitationsResponseList(BaseModel):
    objects: list[Object] | None = None
    response: V1ListResponse | None = None


class V1ListInvitationsResponse(BaseModel):
    count_response: V1CountResponse | None = None
    group_response: V1GroupResponse | None = None
    list: V1ListInvitationsResponseList | None = None


class InvitationService(BaseModel):
    InvitationServiceCreateInvitationBody_1: (
        InvitationServiceCreateInvitationBody | None
    ) = Field(None, alias='InvitationServiceCreateInvitationBody')
    v1Invitation: V1Invitation | None = None
    v1ListInvitationsResponse: V1ListInvitationsResponse | None = None
