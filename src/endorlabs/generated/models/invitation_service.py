...
class V1InvitationSpec(BaseModel):
    ...
    user_email: str
    """
    The email of the user that we want to invite to the tenant.
    """
...
class InvitationServiceCreateInvitationBody(BaseModel):
    ...
    tenant_meta: dict[str, Any] | None = Field(
        None, title='Invitations can be issued per namespace.'
    )
    """
...
class V1ListInvitationsResponse(BaseModel):
    """
    Response to the request to list invitations.
    """
