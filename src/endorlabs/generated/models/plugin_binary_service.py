...
class SpecArchType(StrEnum):
    """
    The architecture suitable for the binary.
    """
...
class V1PluginBinarySpec(BaseModel):
    arch_type: SpecArchType | None = 'ARCH_TYPE_UNSPECIFIED'
    """
    The architecture suitable for the binary.
    """
    binary_type: SpecBinaryType | None = 'BINARY_TYPE_UNSPECIFIED'
    """
    The type of the binary.
    """
    checksum: str | None = None
    """
    Checksum of the plugin binary.
    """
    compatibility_matrix: dict[str, V1Constraint] | None = None
    """
    Compatibility matrix containing the min/max supported values for runtime
    tools.
    """
    published_date: AwareDatetime | None = None
    """
    The date when this binary was published.
    """
    unsupported: bool | None = None
    """
    Unsupported identifies this binary as not officially supported by Endor
    Labs.
    """
    url: str | None = None
    """
    The URL from which the binary is retrieved.
    """
    version: str | None = None
    """
    The version of the plugin binary.
    """
...
class V1ListPluginBinariesResponse(BaseModel):
    """
    Response to the request to list plugin binaries.
    """
