...
class V1VectorStoreDocument(BaseModel):
    """
    VectorStoreDocument is the standard format of documents in the vector store.
    """

    content_hash: str | None = None
    """
    content_hash is the SHA256 hash of the document content.
    """
    data: str
    """
    data is the data to upload to the vector store.
    """
    metadata: dict[str, Any] | None = None
    """
    metadata is the metadata of the document.
    """
    save_content: bool | None = None
    """
    save_content controls whether document content is saved to the store.
    """
...
class V1VectorStoreQuerySpec(BaseModel):
    ...
    """
    vector_store_uuid is the ID of the vector store to upload data.
    """


class V1VectorStoreQuery(BaseModel):
    """
    VectorStoreQuery is the message to query the vector store.
    """
