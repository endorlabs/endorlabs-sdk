...
class LicenseNoticesReportSpecGrouping(StrEnum):
    """
    The grouping of the license notices report.
...
class LicenseNoticesReportSpecReportType(StrEnum):
    """
    The report type of the license notices report.
...
class V1LicenseNoticesReportSpec(BaseModel):
    contents: Base64Str | None = None
    """
    The contents of the license notices report.
    """
    grouping: LicenseNoticesReportSpecGrouping
    """
    The grouping of the license notices report.
    """
    package_license_edit_uuid: str | None = None
    """
    Deprecated: not used by current implementations; kept for wire compatibility.
    """
    package_version_uuid: str
    """
    UUID of the package version for which this report is generated.
    ...
    """
    report_type: LicenseNoticesReportSpecReportType
    """
    The report type of the license notices report.
    """
...
class LicenseNoticesReportServiceCreateLicenseNoticesReportBody(BaseModel):
    context: V1Context
    """
    The context of the license notices report.
    """
    meta: V1Meta
    """
    Metadata required for all objects.
    """
    spec: V1LicenseNoticesReportSpec
    """
    The specification of the license notices report.
    """
    ...
    uuid: str | None = None
    """
    The UUID of the license notices report.
    """
