...
#   filename:  a_p_i_key_service.json
...
class V1APIKeySpec(BaseModel):
    ...
    issuing_user: V1User | None = Field(
        None, description='The user that created this API key.'
    )
    key: str | None = Field(None, description='The identifier of an API key.')
    permissions: V1Permissions = Field(
        ..., description='The access permissions associated with the specified API key.'
    )
    secret: str | None = Field(
        None, description='The secret for the specified API key.'
    )
...
class Object(BaseModel):
    ...
    tenant_meta: V1TenantMeta | None = Field(
        None, description='APIKeys are namespaced objects.'
    )
    uuid: str | None = Field(None, description='The UUID of an API key resource.')
