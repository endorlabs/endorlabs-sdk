...
class V1AuthorizationPolicySpec(BaseModel):
    ...
    """
    is_support_policy: bool | None = None
    """
...
class Object(BaseModel):
    ...
    tenant_meta: dict[str, Any] | None = Field(
        None, title='Authorization policies are associated with a tenant.'
    )
    """
    Authorization policies are associated with a tenant.
    """
...
class V1ListAuthorizationPoliciesResponse(BaseModel):
    """
    Response to the request to list all authorization policies for a given
    tenant.
    """
