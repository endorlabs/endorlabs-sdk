...
#   filename:  supported_tool_chain_profile_service.json
...
class SpecSupportedVersions(BaseModel):
    versions: list[Version] | None = None


class SpecToolChain(BaseModel):
    toolchain: dict[str, SpecSupportedVersions] | None = None
...
class V1SupportedVersion(BaseModel):
    default: bool | None = None
    disabled: bool | None = None
    version: V1ToolChainVersion


class SpecArchitecture(BaseModel):
    arch: dict[str, SpecToolChain] | None = None


class V1SupportedToolChainProfileSpec(BaseModel):
    os: dict[str, SpecArchitecture] | None = None


class Object(BaseModel):
    meta: V1Meta = Field(..., description='Meta identifies the tool chain object.')
    spec: V1SupportedToolChainProfileSpec
...
class V1ListSupportedToolChainProfilesResponseList(BaseModel):
    objects: list[Object] | None = None
    response: V1ListResponse | None = None


class V1SupportedToolChainProfile(BaseModel):
    meta: V1Meta = Field(..., description='Meta identifies the tool chain object.')
    spec: V1SupportedToolChainProfileSpec
    tenant_meta: V1TenantMeta
    uuid: str | None = Field(
...
class V1ListSupportedToolChainProfilesResponse(BaseModel):
    count_response: V1CountResponse | None = None
    group_response: V1GroupResponse | None = None
    list: V1ListSupportedToolChainProfilesResponseList | None = None


class SupportedToolChainProfileService(BaseModel):
    v1ListSupportedToolChainProfilesResponse: (
        V1ListSupportedToolChainProfilesResponse | None
    ) = None
    v1SupportedToolChainProfile: V1SupportedToolChainProfile | None = None
