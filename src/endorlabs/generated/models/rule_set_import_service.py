...
class SpecImportedRuleSetResult(BaseModel):
    ...
    """
    The total time in seconds that it took to process the request.
    """
    status: ImportedRuleSetResultImportedRuleSetResultStatus | None = (
        'IMPORTED_RULE_SET_RESULT_STATUS_UNSPECIFIED'
    )
    """
...
class V1RuleSourceType(StrEnum):
    """
    The source type of the rule set.
    """
...
class V1ImportedRuleSetSpec(BaseModel):
    ...
    """
    A file has been used as a source.
    """
    opengrep_validate: bool | None = None
    """
    Validate this import request with opengrep.
    """
    result: SpecImportedRuleSetResult | None = None
    rule_source_type: V1RuleSourceType | None = 'RULE_SOURCE_TYPE_UNSPECIFIED'
    """
    The source type of rules being imported.
    """
    rule_type: V1RuleType
    """
    The type of rules being imported.
    """
    sha256_hash: str | None = None
    """
    The SHA256 checksum if applicable (e.g, file).
    """
    version: str | None = None
    """
    The version for this rule set. All rules in the set will be created with this version.
    """
...
class V1ListRuleSetImportsResponse(BaseModel):
    """
    Response to the request to list.
    """
