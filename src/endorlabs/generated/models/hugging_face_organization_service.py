...
#   filename:  hugging_face_organization_service.json
...
class V1HuggingFaceOrganizationSpec(BaseModel):
    model_names: list[str] | None = Field(
        None, description='Names of models that belong to this organization.'
    )
    organization_name: str | None = Field(
        None, description='Name of the HuggingFace organization.'
    )
    url: str | None = Field(
        None, description='URL of the HuggingFace organization page.'
    )
...
class V1HuggingFaceOrganization(BaseModel):
    meta: V1Meta = Field(..., description='Metadata required for all objects.')
    spec: V1HuggingFaceOrganizationSpec = Field(
        ..., description='The specification of the organization.'
    )
    tenant_meta: V1TenantMeta | None = Field(
        None, description='Organizations scanned per namespace.'
    )
    uuid: str | None = Field(
        None, description='The UUID for the HuggingFace organization.'
    )
...
class V1ListHuggingFaceOrganizationsResponseList(BaseModel):
    objects: list[Object] | None = None
    response: V1ListResponse | None = None


class V1ListHuggingFaceOrganizationsResponse(BaseModel):
    count_response: V1CountResponse | None = None
    group_response: V1GroupResponse | None = None
    list: V1ListHuggingFaceOrganizationsResponseList | None = None


class HuggingFaceOrganizationService(BaseModel):
    v1HuggingFaceOrganization: V1HuggingFaceOrganization | None = None
    v1ListHuggingFaceOrganizationsResponse: (
        V1ListHuggingFaceOrganizationsResponse | None
    ) = None
