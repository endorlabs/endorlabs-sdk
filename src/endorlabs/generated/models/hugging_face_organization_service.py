...
class V1HuggingFaceOrganizationSpec(BaseModel):
    ...
    """
    Names of models that belong to this organization.
    """
    organization_name: str | None = None
    """
    Name of the HuggingFace organization.
    """
    url: str | None = None
    """
    URL of the HuggingFace organization page.
    """
...
class V1HuggingFaceOrganization(BaseModel):
    """
    HuggingFaceOrganization represents a HuggingFace organization and its associated metadata.
    """
    ...
    """
    spec: V1HuggingFaceOrganizationSpec
    """
    The specification of the organization.
    """
    tenant_meta: V1TenantMeta | None = None
    """
    Organizations scanned per namespace.
    """
    uuid: str | None = None
    """
    The UUID for the HuggingFace organization.
    """
...
class V1ListHuggingFaceOrganizationsResponse(BaseModel):
    """
    Response to the request to list HuggingFace organizations.
    """
