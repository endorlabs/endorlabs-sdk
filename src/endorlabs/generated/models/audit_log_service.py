...
class V1AuditLogSpec(BaseModel):
    ...
    """
    error: GooglerpcStatus | None = None
    """
    ...
    """
    Represents the UUID of the resource which is accessed.
    """
    operation: V1AuditLogSpecOperation
    payload: GoogleprotobufAny | None = None
    """
...
class Object(BaseModel):
    """
    AuditLog represents a CRUD operation on a message.
    """
...
class V1ListAuditLogsResponse(BaseModel):
    """
    Response to request to list audit logs.
    """
