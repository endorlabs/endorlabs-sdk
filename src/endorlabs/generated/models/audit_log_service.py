...
#   filename:  audit_log_service.json
...
class V1AuditLogSpecOperation(StrEnum):
...
class V1AuditLogSpec(BaseModel):
    ...
    error: GooglerpcStatus | None = Field(
        None, description='Error if the operation fails.'
    )
    message_kind: str | None = Field(None, description='The kind of the message.')
    message_uuid: str | None = Field(
        None, description='Represents the UUID of the resource which is accessed.'
    )
    operation: V1AuditLogSpecOperation
    payload: GoogleprotobufAny | None = Field(
        None, description='The payload of the message.'
    )
...
class Object(BaseModel):
    ...
    uuid: str | None = Field(None, description='The UUID of the audit log.')


class V1ListAuditLogsResponseList(BaseModel):
...
class V1ListAuditLogsResponse(BaseModel):
    count_response: V1CountResponse | None = None
    group_response: V1GroupResponse | None = None
    list: V1ListAuditLogsResponseList | None = None


class AuditLogService(BaseModel):
    v1AuditLog: V1AuditLog | None = None
    v1ListAuditLogsResponse: V1ListAuditLogsResponse | None = None
