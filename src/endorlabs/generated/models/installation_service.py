...
class SpecEnabledFeatureType(StrEnum):
    """
    - ENABLED_FEATURE_TYPE_AI_SAST_SCAN: Enables AI-powered SAST scanning of source code for security vulnerabilities.
    """
    ...
    ENABLED_FEATURE_TYPE_AI_SAST_SCAN = 'ENABLED_FEATURE_TYPE_AI_SAST_SCAN'
