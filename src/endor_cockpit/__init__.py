...
- Security-first design with built-in scanning capabilities
- Type-safe operations with Pydantic data models
- Resource-oriented architecture for intuitive API interaction
- Agent-optimized design with comprehensive documentation

For AI agents, see the comprehensive documentation in docs/agents/ and AGENTS.md.
"""
