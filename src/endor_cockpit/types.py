...
EcosystemType = Literal[
    "ECOSYSTEM_NPM", "ECOSYSTEM_PYPI", "ECOSYSTEM_MAVEN",
    "ECOSYSTEM_NUGET", "ECOSYSTEM_RUBYGEMS", "ECOSYSTEM_GO",
    "ECOSYSTEM_RUST", "ECOSYSTEM_DOCKER"
]

# Finding Categories
FindingCategoryType = Literal[
    "FINDING_CATEGORY_VULNERABILITY", "FINDING_CATEGORY_SUPPLY_CHAIN",
    "FINDING_CATEGORY_LICENSE_RISK", "FINDING_CATEGORY_SECURITY",
    "FINDING_CATEGORY_SECRETS", "FINDING_CATEGORY_MALWARE"
]

# Policy Types
PolicyType = Literal[
    "POLICY_TYPE_SYSTEM_FINDING", "POLICY_TYPE_USER_FINDING",
    "POLICY_TYPE_ADMISSION", "POLICY_TYPE_ML_FINDING",
...
# Schema Drift Types
SchemaDriftInfo = TypedDict("SchemaDriftInfo", {
    "model_name": str,
