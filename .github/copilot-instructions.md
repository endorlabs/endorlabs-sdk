...
- **API spec (OpenAPI)**: <https://api.endorlabs.com/download/openapiv2.swagger.json> (schema drift workflow downloads to `.endorlabs/_cache/openapi.json` in CI; folder is gitignored)
