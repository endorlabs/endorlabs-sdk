...
description: |
  Use when tracing vulnerability and dependency lineage across Findings,
...
Separate **scope** / **evidence** / **conclusion** in customer writeups ([portable-examples](../../rules/endor-portable-examples.md)). If both API key and `ENDOR_TOKEN` exist, pass `auth_method="browser-auth"`. Package-lineage semantics: [endor-dependency-provenance](../endor-dependency-provenance/SKILL.md).
