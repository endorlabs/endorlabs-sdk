...
description: |
  Use when importing CycloneDX/SPDX SBOMs via endorctl, checking file-vs-project
...
endorlabs:
  catalog:
    workflow_id: sbom-management
    module: endorlabs.workflows.sbom.cli
    cli: endor-sbom
    default_output: .endorlabs/tasks/<slug>-<YYYY-MM-DD>/sbom/
    agent_visible: true
    composition: library_api
    library_entrypoints:
      - endorlabs.workflows.sbom.coverage.run_coverage
      - endorlabs.workflows.sbom.import_sbom.run_import
      - endorlabs.workflows.sbom.export_sbom.run_sbom_export
      - endorlabs.workflows.sbom.export_sbom.run_vex_export
      - endorlabs.workflows.sbom.export_sbom.poll_async_job
---
