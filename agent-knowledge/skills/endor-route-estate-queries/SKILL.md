...
description: >-
  Routes estate-scale data pulls between Query count joins and facade
  list/count/shard patterns after bounded topology discovery. Use when choosing
  how to fetch counts or aggregates across many projects or namespaces. Not for
  single-project RCA or full row exports — hand off to endor-retrieve-scan-results,
  endor-project-retrieval-bundle, or estate pull when rows are needed.
---
