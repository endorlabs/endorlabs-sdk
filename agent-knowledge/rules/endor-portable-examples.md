...
tags: [examples, hygiene, placeholders, tests, fixtures]
summary: >-
  Use placeholders in all git-tracked content; never commit customer estate
  identifiers, PII, or secrets (tenants, project URLs, production UUIDs, emails)
  across docs, skills, unit fixtures, docstrings, and CLI examples.
---
