...
Usage:
  uv run python scripts/probe_endor_mcp_tools.py
  uv run python scripts/probe_endor_mcp_tools.py --dump-tools-json .tmp/mcp_tools.json
  set ENDORCTL=G:\\Tools\\endorctl\\endorctl.exe
  uv run python scripts/probe_endor_mcp_tools.py --endorctl "%ENDORCTL%"
"""
