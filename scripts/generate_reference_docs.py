...
RESOURCE_LIMITATIONS: dict[str, str] = {
    ...
    "authentication_log": 'System-owned; get only for namespace="oss"',
    "endor_license": 'System-owned; get only for namespace="oss"',
    "policy_template": 'System-owned; get only for namespace="oss"',
