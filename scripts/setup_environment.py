...
def print_setup_instructions():
    ...
    print("\n4. 🧪 Test the setup:")
    print("   - Run: uv run python -c 'from endor_cockpit.api_client import EndorClient; print(\"SDK import successful\")'")
...
def main():
    ...
    # Summary
    required_ok = all(results.get(var, False) for var in [
        "ENDOR_API", "ENDOR_API_CREDENTIALS_KEY", "ENDOR_API_CREDENTIALS_SECRET"
    ])
